        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-ticket"></i> <span>PLN Token</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cubes"></i> Master Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url.'?page=data_pelanggan'; ?>">Data Pelanggan</a></li>
                      <li><a href="<?php echo base_url.'?page=data_token'; ?>">Token</a></li>
                      <li><a href="<?php echo base_url.'?page=data_daya'; ?>">Daya Listrik</a></li>
                    </ul>
                  </li>
